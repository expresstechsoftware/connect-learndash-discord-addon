...
<?php wp_nonce_field( 'learndash_discord_appearance_settings_nonce', 'ets_learndash_discord_appearance_settings_nonce' ); ?>
  <table class="form-table" role="presentation">
	<tbody>
	<tr>
		<th scope="row"><?php esc_html_e( 'Connect/Login Button background color', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>        
		<th scope="row"><?php esc_html_e( 'Disconnect Button background color', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Text on the Button for logged-in users', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Text on the Button for non-login users', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Text on the Disconnect Button', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
