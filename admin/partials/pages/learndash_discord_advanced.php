...
<?php wp_nonce_field( 'learndash_discord_advance_settings_nonce', 'ets_learndash_discord_advance_settings_nonce' ); ?>
  <table class="form-table" role="presentation">
	<tbody>
	<tr>
		<th scope="row"><?php echo __( 'Shortcode:', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
		[learndash_discord]
		<br/>
		<small><?php echo __( 'Use this shortcode [learndash_discord] to display connect to discord button on any page.', 'connect-learndash-discord-addon' ); ?></small>
		</fieldset></td>
	</tr>
	<tr>
		<th scope="row"><?php echo __( 'Use rich embed messaging feature?', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Remove student discord role when course access expires?', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Send welcome message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Welcome message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Send Course Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Course Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Send Lesson Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Lesson Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<small>Merge fields:  [LD_STUDENT_NAME], [LD_STUDENT_EMAIL], [LD_LESSON_NAME], [LD_COURSE_LESSON_DATE], [SITE_URL], [BLOG_NAME]</small>
 	...
 	<tr>
		<th scope="row"><?php echo __( 'Send Topic Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Topic Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
  ...
  <tr>
		<th scope="row"><?php echo __( 'Send Quiz Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Quiz Complete message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
  ...
  <tr>
		<th scope="row"><?php echo __( 'Send Assignment Approved message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Assignment Approved message', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<small>Merge fields: [LD_STUDENT_NAME], [LD_STUDENT_EMAIL], [LD_ASSIGNMENT_COURSE], [LD_ASSIGNMENT_LESSON], [SITE_URL], [BLOG_NAME], [LD_ASSIGNMENT_APPROVED_DATE], [LD_LINK_OF_ASSIGNMENT], [LD_ASSIGNMENT_POINTS_AWARDED]</small>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Retry Failed API calls', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Don\'t kick students upon disconnect', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'How many times a failed API call should get re-try', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Set job queue concurrency', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Set job queue batch size', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Log API calls response (For debugging purpose)', 'connect-learndash-discord-addon' ); ?></th>
		<td> <fieldset>
