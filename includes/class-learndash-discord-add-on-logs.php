 ...
 */
class LearnDash_Discord_Add_On_Logs {
	function __construct() {
		// Clear all existing logs.
		add_action( 'wp_ajax_ets_learndash_discord_clear_logs', array( $this, 'ets_learndash_discord_clear_logs' ) );
	}
	 ...
	 */
	public static $log_file_name = 'learndash_discord_api_logs.txt';
	 ...
	 * @return None
	 */
	public function ets_learndash_discord_clear_logs() {
...
new LearnDash_Discord_Add_On_Logs();
